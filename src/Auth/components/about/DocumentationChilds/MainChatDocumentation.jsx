...
const MAIN_CHAT_URL =
  "https://raw.githubusercontent.com/hyloosec-official-creator/hyloosec-documentation/main/user-manual/main-chat.json";

const MainChatDocumentation = ({ onHome }) => {
  ...
  useEffect(() => {
    const fetchDocumentation = async () => {
      try {
        ...
        const response = await fetch(MAIN_CHAT_URL);
        ...
        console.error("Main Chat documentation fetch error:", err);
        setError("Unable to load Main Chat documentation.");
      } finally {
        setLoading(false);
      }
    };
...
export default MainChatDocumentation;