...
const LOGIN_URL =
  "https://raw.githubusercontent.com/hyloosec-official-creator/hyloosec-documentation/main/user-manual/login.json";

const LoginDocumentation = ({onHome}) => {
  ...
  useEffect(() => {
    const fetchDocumentation = async () => {
      try {
        ...
        console.error("Login documentation fetch error:", err);
        setError("Unable to load Login documentation.");
      } finally {
        setLoading(false);
      }
    };
