...
const FORGOT_PASSWORD_URL =
  "https://raw.githubusercontent.com/hyloosec-official-creator/hyloosec-documentation/main/user-manual/forgot-password.json";

const ForgotPasswordDocumentation = ({ onHome }) => {
  ...
  useEffect(() => {
    const fetchDocumentation = async () => {
      try {
        ...
        console.error(
          "Forgot Password documentation fetch error:",
          err
        );

        setError(
          "Unable to load Reset Password documentation."
        );
      } finally {
        setLoading(false);
      }
...
export default ForgotPasswordDocumentation;