...
const SuccessInfo = () => {
  ...
  useEffect(() => {
    const createSecurePdf = async () => {
      if (registrationData && !isVerified) {
        ...
        const fullQuestion =
          questionMapping[securityQuestion] || securityQuestion;
        ...
        try {
          ...
          page.drawText(
            "=====================================================",
            { x: 30, y: 460, size: 14, font: boldFont },
          );
          page.drawText("       HYLOOSEC - OFFICIAL CREDENTIALS", {
            x: 30,
            y: 440,
            size: 16,
            font: boldFont,
          ...
          page.drawText(
            "=====================================================",
            { x: 30, y: 420, size: 14, font: boldFont },
          );
          ...
          page.drawText(`Full Name            : ${username}`, {
            x: 30,
            y: 350,
            size: 12,
            font,
          ...
          page.drawText(`Father's Name     : ${fatherName}`, {
            x: 30,
            y: 310,
            size: 12,
            font,
          ...
          page.drawText(
            "---------------------------------------------------------------------------------------------------",
            { x: 30, y: 270, size: 12, font },
          );

          page.drawText("CRITICAL FORGET PASSWORD / IDENTITY RECOVERY DATA:", {
            x: 30,
            y: 250,
            size: 12,
            font: boldFont,
          });
          page.drawText(`Security Question : ${fullQuestion}`, {
            x: 30,
            y: 230,
            size: 11,
            font,
          });
          page.drawText(`Security Answer   : ${securityAnswer}`, {
            x: 30,
            y: 210,
            size: 11,
            font,
          ...
          page.drawText(
            "---------------------------------------------------------------------------------------------------",
            { x: 30, y: 190, size: 12, font },
          );

          page.drawText("ENCRYPTION & SYSTEM INFO:", {
            x: 30,
            y: 170,
            size: 12,
            font: boldFont,
          ...
          page.drawText(
            ...
            { x: 30, y: 150, size: 11, font },
          );
          page.drawText(`Registered From   : ${city}, ${country}`, {
            x: 30,
            y: 130,
            size: 11,
            font,
          });
          page.drawText(`Registration IP    : ${ip}`, {
            x: 30,
            y: 110,
            size: 11,
            font,
  ...
  return (
    ...
    >
      ...
      <div
        className="info-box"
        style={{ margin: "20px 0", padding: "10px", border: "1px dashed #aaa" }}
      >
      ...
      {!isVerified && (
        ...
        >
          ...
          <p style={{ margin: "5px 0", fontSize: "0.9rem", color: "#ccc" }}>
            आपकी क्रेडेंशियल फाइल पूरी तरह एन्क्रिप्टेड डाउनलोड हुई है। इसे
            खोलने के लिए नीचे दिए गए फॉर्मेट में पासवर्ड डालें:
          </p>
          <div
            style={{
              background: "#2a2a40",
